CREATE TABLE IF NOT EXISTS app_cashflow.transaction
(
    id                         BIGSERIAL PRIMARY KEY,
    transaction_id             BIGINT         NOT NULL,
    customer_id                VARCHAR(15)    NOT NULL REFERENCES app_cashflow.customer (customer_id),
    ...
    counterparty_bank_name     VARCHAR(45)    NOT NULL,
